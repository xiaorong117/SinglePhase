#include "JacobianAssembler_LinearEquation.hpp"
#include <iostream>
#include <stdexcept>
...
// ----------------------------------------------------------------------
int JacobianAssembler_LinearEquation::deduce_n_var_per_node(const SystemMatrixConfig& config) const {
...
// 构造函数
// ----------------------------------------------------------------------
JacobianAssembler_LinearEquation::JacobianAssembler_LinearEquation(const SystemMatrixConfig& config) : config_(config) {
...
// 核心组装函数：assemble(dt)
// ----------------------------------------------------------------------
void JacobianAssembler_LinearEquation::assemble(double dt) {
  // 1. 获取尺寸和数据指针
