...
template <typename T> using reverse_mode = B<T>;
static int FLAG = 0;
std::vector<int> inlet_boundary(1259);
// 输出vector到文件
void writeVectorToFile(const std::vector<int> &vec,
...
private:
  ...
  reverse_mode<double> conductivity_sur_test(reverse_mode<double> &Pi,
                                             reverse_mode<double> *Pjs,
                                             reverse_mode<double> &Wi,
                                             reverse_mode<double> *Wjs,
                                             int pore_id, int throat_id);
  reverse_mode<double> conductivity_bulk_test(reverse_mode<double> &Pi,
                                              reverse_mode<double> *Pjs,
                                              reverse_mode<double> &Wi,
                                              reverse_mode<double> *Wjs,
                                              int pore_id, int throat_id);
  reverse_mode<double> conductivity_bulk(reverse_mode<double> &Pi,
                                         reverse_mode<double> *Pjs,
                                         reverse_mode<double> &Wi,
                                         reverse_mode<double> *Wjs, int pore_id,
                                         int throat_id);
  reverse_mode<double> conductivity_co2_DISPERSION(reverse_mode<double> &Pi,
                                                   reverse_mode<double> *Pjs,
                                                   reverse_mode<double> &Wi,
                                                   reverse_mode<double> *Wjs,
                                                   int pore_id, int throat_id);
  reverse_mode<double> conductivity_mehane_SURFACEDIFFUSION(
      reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
      reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int pore_id,
      int throat_id);
  reverse_mode<double> conductivity_co2_SURFACEDIFFUSION(
      reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
      reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int pore_id,
      int throat_id);
  vector<reverse_mode<double>> ex_adsorption(reverse_mode<double> &Pi,
                                             reverse_mode<double> &Wi,
                                             int pore_id);
  vector<double> ex_adsorption(double Pi, double Wi, int pore_id); // 压缩系数
  vector<reverse_mode<double>> ex_adsorption_pro(reverse_mode<double> &Pi,
                                                 reverse_mode<double> &Wi,
                                                 int pore_id);
  vector<double> ex_adsorption_pro(double Pi, double Wi,
                                   int pore_id); // 压缩系数

  reverse_mode<double> conductivity_bulk_kong(reverse_mode<double> &Pi,
                                              reverse_mode<double> *Pjs,
                                              reverse_mode<double> &Wi,
                                              reverse_mode<double> *Wjs,
                                              int pore_id, int throat_id);
  reverse_mode<double> conductivity_co2_DISPERSION_kong(
      reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
      reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int pore_id,
      int throat_id);
  ...
  reverse_mode<double> func(reverse_mode<double> &Pi,
                            reverse_mode<double> *&Pjs, int num);
  reverse_mode<double> func_BULK_PHASE_FLOW_in_macro_produc(
      reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
      reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int num);
  reverse_mode<double> func_BULK_PHASE_FLOW_in_micro_produc(
      reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
      reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int num);
  reverse_mode<double> func_BULK_PHASE_FLOW_in_macro(reverse_mode<double> &Pi,
                                                     reverse_mode<double> *Pjs,
                                                     reverse_mode<double> &Wi,
                                                     reverse_mode<double> *Wjs,
                                                     int num);
  reverse_mode<double> func_BULK_PHASE_FLOW_in_micro(reverse_mode<double> &Pi,
                                                     reverse_mode<double> *Pjs,
                                                     reverse_mode<double> &Wi,
                                                     reverse_mode<double> *Wjs,
                                                     int num);
  reverse_mode<double> func_TRANSPORT_FLOW_in_macro(reverse_mode<double> &Pi,
                                                    reverse_mode<double> *Pjs,
                                                    reverse_mode<double> &Wi,
                                                    reverse_mode<double> *Wjs,
                                                    int num);
  reverse_mode<double> func_TRANSPORT_FLOW_in_micro(reverse_mode<double> &Pi,
                                                    reverse_mode<double> *Pjs,
                                                    reverse_mode<double> &Wi,
                                                    reverse_mode<double> *Wjs,
                                                    int num);

  reverse_mode<double> func_BULK_PHASE_FLOW_kong(reverse_mode<double> &Pi,
                                                 reverse_mode<double> *Pjs,
                                                 reverse_mode<double> &Wi,
                                                 reverse_mode<double> *Wjs,
                                                 int num);
  reverse_mode<double> func_TRANSPORT_FLOW_kong(reverse_mode<double> &Pi,
                                                reverse_mode<double> *Pjs,
                                                reverse_mode<double> &Wi,
                                                reverse_mode<double> *Wjs,
                                                int num);

  void AMGXsolver_subroutine_co2_mehane(
      AMGX_matrix_handle &A_amgx, AMGX_vector_handle &b_amgx,
      AMGX_vector_handle &solution_amgx, AMGX_solver_handle &solver, int n_amgx,
      int nnz_amgx); // 混合模型方程求解以及变量更新
  void AMGXsolver_subroutine_kong(AMGX_matrix_handle &A_amgx,
...
*/
vector<reverse_mode<double>> PNMsolver::ex_adsorption(reverse_mode<double> &Pi,
                                                      reverse_mode<double> &Wi,
                                                      int Pore_id) {
  ...
  Mass_density_bulk =
      Pi * Mole_mass_bulk / (Pb[Pore_id].compre * 8.314 * Temperature);

  Adsorption_co2 =
      n_max_ad_co2 * (K_langmuir_co2 * Pi * Wi) /
      (1 + K_langmuir_co2 * Pi * Wi + K_langmuir_ch4 * Pi * (1 - Wi));
  mass_frac_co2 =
      Wi * MOLE_MASS_CO2 / (MOLE_MASS_CO2 * Wi + MOLE_MASS_CH4 * (1 - Wi));

  Adsorption_ch4 =
      n_max_ad_ch4 * (K_langmuir_ch4 * Pi * (1 - Wi)) /
      (1 + K_langmuir_co2 * Pi * Wi + K_langmuir_ch4 * Pi * (1 - Wi));
  ...
  ex_Adsorption_ch4 =
      Adsorption_ch4 * (1 - mass_frac_ch4 * Mass_density_bulk /
                                (mass_frac_Adsorption_ch4 * Rho_ad));
  ex_Adsorption_co2 =
      Adsorption_co2 * (1 - mass_frac_co2 * Mass_density_bulk /
                                (mass_frac_Adsorption_co2 * Rho_ad));
...
for primary related variables
*/
vector<reverse_mode<double>>
PNMsolver::ex_adsorption_pro(reverse_mode<double> &Pi, reverse_mode<double> &Wi,
                             int Pore_id) {
  reverse_mode<double> Adsorption_ch4{0};
  reverse_mode<double> ex_Adsorption_ch4{0};
  ...
  ex_Adsorption_ch4 =
      n_max_ad * Adsorption_ch4 * (1 - Mass_density_bulk / (Rho_ad));
...
reverse_mode<double> PNMsolver::conductivity_sur_test(reverse_mode<double> &Pi,
                                                      reverse_mode<double> *Pjs,
                                                      reverse_mode<double> &Wi,
                                                      reverse_mode<double> *Wjs,
                                                      int Pore_id,
  ...
  if (Tb_in[i].ID_1 < macro_n && Tb_in[i].ID_2 < macro_n) {
    ...
    Tb_in[i].surface_diff_co2 =
        Ds * pi * pow(Tb_in[i].Radiu, 2) / Tb_in[i].Length;
    Tb_in[i].surface_diff_methane =
        Ds * pi * pow(Tb_in[i].Radiu, 2) / Tb_in[i].Length;
    ...
    Tb_in[i].Conductivity = Slip * Pb[Tb_in[i].ID_1].km * Tb_in[i].Radiu /
                            (Average_visco * Tb_in[i].Length);
    Tb_in[i].surface_diff_co2 =
        Tb_in[i].Radiu * Ds * n_max_ad / Tb_in[i].Length;
    Tb_in[i].surface_diff_methane =
        Tb_in[i].Radiu * Ds * n_max_ad / Tb_in[i].Length;
    Tb_in[i].Surface_diff_conduc =
        Tb_in[i].Radiu * Ds * n_max_ad / Tb_in[i].Length;
...
reverse_mode<double> PNMsolver::conductivity_bulk_test(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id,
    int throat_id) {
  // 水力传导系数计算
...
reverse_mode<double> PNMsolver::conductivity_bulk(reverse_mode<double> &Pi,
                                                  reverse_mode<double> *Pjs,
                                                  reverse_mode<double> &Wi,
                                                  reverse_mode<double> *Wjs,
                                                  int Pore_id, int throat_id) {
  ...
  double Average_visco =
      (Pb[Tb_in[i].ID_1].visco + Pb[Tb_in[i].ID_2].visco) / 2;
  if (Tb_in[i].ID_1 < macro_n && Tb_in[i].ID_2 < macro_n) {
    Knusen_number1 = Pb[Tb_in[i].ID_1].visco /
                     (Pb[Tb_in[i].ID_1].pressure + refer_pressure) *
                     sqrt(pi * Pb[Tb_in[i].ID_1].compre * 8.314 * Temperature /
                          (2 * 0.016)) /
                     (Pb[Tb_in[i].ID_1].Radiu * 2);
    Knusen_number2 = Pb[Tb_in[i].ID_2].visco /
                     (Pb[Tb_in[i].ID_2].pressure + refer_pressure) *
                     sqrt(pi * Pb[Tb_in[i].ID_2].compre * 8.314 * Temperature /
                          (2 * 0.016)) /
                     (Pb[Tb_in[i].ID_2].Radiu * 2);
    Tb_in[i].Knusen = (Knusen_number1 + Knusen_number2) / 2;
    alpha = 1.358 * 2 / pi * atan(4 * pow(Tb_in[i].Knusen, 0.4));
    Slip1 = (1 + alpha * Knusen_number1) *
            (1 + beta * Knusen_number1 / (1 + Knusen_number1));
    Slip2 = (1 + alpha * Knusen_number2) *
            (1 + beta * Knusen_number2 / (1 + Knusen_number2));
    ...
    Tb_in[i].Conductivity = Tb_in[i].Slip * pi * pow(Tb_in[i].Radiu, 4) /
                            (8 * Average_visco * Tb_in[i].Length);
    reverse_mode<double> conductivity = Tb_in[i].Conductivity;
    return conductivity;
  } else if ((Tb_in[i].ID_1 < macro_n && Tb_in[i].ID_2 >= macro_n)) {
    ...
    temp2 = abs(Pb[Tb_in[i].ID_2].km * Tb_in[i].Radiu * angle2 /
                (Average_visco * length2));
    ...
    temp1 = abs(Pb[Tb_in[i].ID_1].km * Tb_in[i].Radiu * angle1 /
                (Average_visco * length1));
    ...
    Tb_in[i].Conductivity = Tb_in[i].Slip * Pb[Tb_in[i].ID_1].km *
                            Tb_in[i].Radiu / (Average_visco * Tb_in[i].Length);
    reverse_mode<double> conductivity = Tb_in[i].Conductivity;
    return conductivity;
  } else {
    Knusen_number1 = Pb[Tb_in[i].ID_1].visco /
    ...
    temp1 = abs(Tb_in[i].Slip * Pb[Tb_in[i].ID_1].km * Tb_in[i].Radiu * angle1 /
                (Average_visco * length1));
    temp2 = abs(Tb_in[i].Slip * Pb[Tb_in[i].ID_2].km * Tb_in[i].Radiu * angle2 /
                (Average_visco * length2));
...
reverse_mode<double> PNMsolver::conductivity_co2_DISPERSION(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id,
    int throat_id) {
  // 水力传导系数计算
  ...
  if (Tb_in[i].ID_1 < macro_n && Tb_in[i].ID_2 < macro_n) {
    ...
    Tb_in[i].dispersion_coe_co2 =
        D_dispersion * pi * pow(Tb_in[i].Radiu, 2) / Tb_in[i].Length;
    ...
    return conductivity;
             ...
             Tb_in[i].ID_2 >= pn - m_outlet) {
    Tb_in[i].dispersion_coe_co2 =
        Tb_in[i].Radiu * D_dispersion / Tb_in[i].Length;
    reverse_mode<double> conductivity = Tb_in[i].dispersion_coe_co2;
    return conductivity;
  } else {
    length1 = sqrt(pow(Pb[Tb_in[i].ID_1].X - Tb_in[i].center_x, 2) +
...
reverse_mode<double> PNMsolver::conductivity_mehane_SURFACEDIFFUSION(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id,
    int throat_id) {
  // 水力传导系数计算
  ...
  if (Tb_in[i].ID_1 < macro_n && Tb_in[i].ID_2 < macro_n) {
    ...
    Tb_in[i].surface_diff_methane = temp_sur_methane_1 * temp_sur_methane_2 /
                                    (temp_sur_methane_1 + temp_sur_methane_2);
    reverse_mode<double> conductivity = Tb_in[i].surface_diff_methane;
    return conductivity;
  } else if ((Tb_in[i].ID_1 >= macro_n && Tb_in[i].ID_2 < macro_n)) {
    length1 = sqrt(pow(Pb[Tb_in[i].ID_1].X - Tb_in[i].center_x, 2) +
...
reverse_mode<double> PNMsolver::conductivity_co2_SURFACEDIFFUSION(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id,
    int throat_id) {
  // 水力传导系数计算
  ...
  if (Tb_in[i].ID_1 < macro_n && Tb_in[i].ID_2 < macro_n) {
    ...
    Tb_in[i].surface_diff_co2 =
        temp_sur_co2_1 * temp_sur_co2_2 / (temp_sur_co2_1 + temp_sur_co2_2);
    reverse_mode<double> conductivity = Tb_in[i].surface_diff_co2;
    return conductivity;
  } else if ((Tb_in[i].ID_1 >= macro_n && Tb_in[i].ID_2 < macro_n)) {
    length1 = sqrt(pow(Pb[Tb_in[i].ID_1].X - Tb_in[i].center_x, 2) +
...
reverse_mode<double> PNMsolver::func_BULK_PHASE_FLOW_in_micro(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id) {
  ...
  Mole_mass_bulk_old = MOLE_MASS_CO2 * Pb[Pore_id].mole_frac_co2_old +
                       MOLE_MASS_CH4 * (1 - Pb[Pore_id].mole_frac_co2_old);
  Mass_density_bulk_old = (Pb[Pore_id].pressure_old + refer_pressure) *
                          Mole_mass_bulk_old /
                          (Pb[Pore_id].compre_old * 8.314 * Temperature);
  Return += Pb[Pore_id].volume * porosity *
            (Mass_density_bulk - Mass_density_bulk_old) / dt;

  Return += Pb[Pore_id].volume *
            (ex_adsorption(Pi, Wi, Pore_id)[0] -
             ex_adsorption(Pb[Pore_id].pressure_old + refer_pressure,
                           Pb[Pore_id].mole_frac_co2_old, Pore_id)[0] +
             ex_adsorption(Pi, Wi, Pore_id)[1] -
             ex_adsorption(Pb[Pore_id].pressure_old + refer_pressure,
                           Pb[Pore_id].mole_frac_co2_old, Pore_id)[1]) /
            dt;

  /* 流量项 */
  size_t iCounter{0};
  int ID2 = Tb_in[Pb[Pore_id].full_accum_ori - Pb[Pore_id].full_coord_ori].ID_2;
  for (int j = Pb[Pore_id].full_accum_ori - Pb[Pore_id].full_coord_ori;
       j < Pb[Pore_id].full_accum_ori; j++) {
    ...
    if (Pb[Tb_in[j].ID_1].pressure > Pb[Tb_in[j].ID_2].pressure) {
      Mole_mass_bulk = MOLE_MASS_CO2 * Wi + MOLE_MASS_CH4 * (1 - Wi);
      Mass_density_bulk = Pi * Mole_mass_bulk /
                          (Pb[Tb_in[j].ID_1].compre * 8.314 * Temperature);
      Conductivity = conductivity_bulk(Pi, Pjs, Wi, Wjs, Pore_id, j);
      conductivity_co2_SUR =
          conductivity_co2_SURFACEDIFFUSION(Pi, Pjs, Wi, Wjs, Pore_id, j);
      conductivity_ch4_SUR =
          conductivity_mehane_SURFACEDIFFUSION(Pi, Pjs, Wi, Wjs, Pore_id, j);

      Return += Mass_density_bulk * Conductivity * (Pi - Pjs[iCounter]);
      Return +=
          conductivity_co2_SUR * (ex_adsorption(Pi, Wi, Pore_id)[2] -
                                  ex_adsorption(Pjs[iCounter], Wi, Pore_id)[2]);
      Return += conductivity_ch4_SUR *
                (ex_adsorption(Pi, Wi, Pore_id)[3] -
                 ex_adsorption(Pjs[iCounter], Wjs[iCounter], Pore_id)[3]);
    } else {
      Mole_mass_bulk =
          MOLE_MASS_CO2 * Wjs[iCounter] + MOLE_MASS_CH4 * (1 - Wjs[iCounter]);
      Mass_density_bulk = Pjs[iCounter] * Mole_mass_bulk /
                          (Pb[Tb_in[j].ID_2].compre * 8.314 * Temperature);
      Conductivity = conductivity_bulk(Pi, Pjs, Wi, Wjs, Pore_id, j);
      conductivity_co2_SUR =
          conductivity_co2_SURFACEDIFFUSION(Pi, Pjs, Wi, Wjs, Pore_id, j);
      conductivity_ch4_SUR =
...
reverse_mode<double> PNMsolver::func_BULK_PHASE_FLOW_in_macro(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id) {
  reverse_mode<double> Return{0};
  reverse_mode<double> Mass_density_bulk{0};
  ...
  Mole_mass_bulk_old = MOLE_MASS_CO2 * Pb[Pore_id].mole_frac_co2_old +
                       MOLE_MASS_CH4 * (1 - Pb[Pore_id].mole_frac_co2_old);
  Mass_density_bulk_old =
      Pi * Mole_mass_bulk_old / (Pb[Pore_id].compre_old * 8.314 * Temperature);
  Return +=
      Pb[Pore_id].volume * (Mass_density_bulk - Mass_density_bulk_old) / dt;
  ...
  for (int j = Pb[Pore_id].full_accum_ori - Pb[Pore_id].full_coord_ori;
    ...
    if (Pb[Tb_in[j].ID_1].pressure > Pb[Tb_in[j].ID_2].pressure) {
      ...
      Mole_mass_bulk =
          MOLE_MASS_CO2 * Wjs[iCounter] + MOLE_MASS_CH4 * (1 - Wjs[iCounter]);
      Mass_density_bulk = Pjs[iCounter] * Mole_mass_bulk /
                          (Pb[ID2].compre * 8.314 * Temperature);
      Conductivity = conductivity_bulk(Pi, Pjs, Wi, Wjs, Pore_id, j);
      Return += Mass_density_bulk * Conductivity * (Pi - Pjs[iCounter]);
    }
  }
...
reverse_mode<double> PNMsolver::func_TRANSPORT_FLOW_in_macro(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id) {
  reverse_mode<double> Return{0};
  reverse_mode<double> Mass_density_bulk{0};
  ...
  Mass_frac_co2_old = ex_adsorption((Pb[Pore_id].pressure_old + refer_pressure),
                                    Pb[Pore_id].mole_frac_co2_old, Pore_id)[4];
  Return += Pb[Pore_id].volume *
            (Mass_density_bulk * Mass_frac_co2 -
             Mass_density_bulk_old * Mass_frac_co2_old) /
            dt;
  ...
  for (int j = Pb[Pore_id].full_accum_ori - Pb[Pore_id].full_coord_ori;
    ...
    if (Pb[Tb_in[j].ID_1].pressure > Pb[Tb_in[j].ID_2].pressure) {
      ...
      Mass_density_bulk =
          Pi * Mole_mass_bulk / (Pb[Pore_id].compre * 8.314 * Temperature);
      Conductivity = conductivity_bulk(Pi, Pjs, Wi, Wjs, Pore_id, j);
      Conductivity_dis_co2 =
          conductivity_co2_DISPERSION(Pi, Pjs, Wi, Wjs, Pore_id, j);

      Return += Mass_frac_co2 * Mass_density_bulk * Conductivity *
                (Pi - Pjs[iCounter]); // co2 advection term
      Return += Mass_density_bulk * Conductivity_dis_co2 *
                (ex_adsorption(Pi, Wi, Pore_id)[4] -
                 ex_adsorption(Pjs[iCounter], Wjs[iCounter],
...
reverse_mode<double> PNMsolver::func_TRANSPORT_FLOW_in_micro(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id) {
  reverse_mode<double> Return{0};
  reverse_mode<double> Mass_density_bulk{0};
    ...
    if (Pb[Tb_in[j].ID_1].pressure > Pb[Tb_in[j].ID_2].pressure) {
      ...
      Return += Mass_density_bulk * Conductivity_dis_co2 *
                (ex_adsorption(Pi, Wi, Pore_id)[4] -
                 ex_adsorption(Pjs[iCounter], Wjs[iCounter],
                               ID2)[4]); // co2 dispersion term
      Return += conductivity_co2_SUR *
                (ex_adsorption(Pi, Wi, Pore_id)[2] -
                 ex_adsorption(Pjs[iCounter], Wjs[iCounter], Tb_in[j].ID_2)[2]);
    } else {
      Mole_mass_bulk =
          MOLE_MASS_CO2 * Wjs[iCounter] + MOLE_MASS_CH4 * (1 - Wjs[iCounter]);
      Mass_density_bulk = Pjs[iCounter] * Mole_mass_bulk /
      ...
      Return += conductivity_co2_SUR *
                (ex_adsorption(Pi, Wi, Pore_id)[2] -
                 ex_adsorption(Pjs[iCounter], Wjs[iCounter], ID2)[2]);
    }
  }
  return Return;
}

reverse_mode<double> PNMsolver::func_BULK_PHASE_FLOW_in_micro_produc(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id) {
  reverse_mode<double> Return{0};
  reverse_mode<double> Mass_density_bulk{0};
  ...
  Return += Pb[Pore_id].volume *
            (ex_adsorption_pro(Pi, Wi, Pore_id)[0] -
             ex_adsorption_pro((Pb[Pore_id].pressure_old + refer_pressure),
                               Pb[Pore_id].mole_frac_co2_old, Pore_id)[0]) /
            dt;
  ...
  for (int j = Pb[Pore_id].full_accum_ori - Pb[Pore_id].full_coord_ori;
    ...
    if (Pb[Tb_in[j].ID_1].pressure > Pb[Tb_in[j].ID_2].pressure) {
      ...
      conductivity_ch4_SUR =
          conductivity_sur_test(Pi, Pjs, Wi, Wjs, Pore_id, j);

      Return += Mass_density_bulk * Conductivity * (Pi - Pjs[iCounter]);
      Return +=
          conductivity_ch4_SUR *
          (ex_adsorption_pro(Pi, Wi, Pore_id)[1] -
           ex_adsorption_pro(Pjs[iCounter], Wjs[iCounter], Tb_in[j].ID_2)[1]);
    } else {
      Mass_density_bulk = Pjs[iCounter] * Mole_mass_bulk /
                          (Pb[Tb_in[j].ID_2].compre * 8.314 * Temperature);
      Conductivity = conductivity_bulk_test(Pi, Pjs, Wi, Wjs, Pore_id, j);
...
reverse_mode<double> PNMsolver::func_BULK_PHASE_FLOW_in_macro_produc(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id) {
  reverse_mode<double> Return{0};
  reverse_mode<double> Mass_density_bulk{0};
  ...
  Mass_density_bulk_old = (Pb[Pore_id].pressure_old + refer_pressure) * 0.016 /
                          (Pb[Pore_id].compre_old * 8.314 * Temperature);
  Return +=
      Pb[Pore_id].volume * (Mass_density_bulk - Mass_density_bulk_old) / dt;
  ...
  for (int j = Pb[Pore_id].full_accum_ori - Pb[Pore_id].full_coord_ori;
    ...
    if (Pb[Tb_in[j].ID_1].pressure > Pb[Tb_in[j].ID_2].pressure) {
      Mass_density_bulk =
          Pi * 0.016 / (Pb[Pore_id].compre * 8.314 * Temperature);
      Conductivity = conductivity_bulk_test(Pi, Pjs, Wi, Wjs, Pore_id, j);
      Return += Mass_density_bulk * Conductivity * (Pi - Pjs[iCounter]);
    } else {
      Mass_density_bulk =
          Pjs[iCounter] * 0.016 / (Pb[ID2].compre * 8.314 * Temperature);
      Conductivity = conductivity_bulk_test(Pi, Pjs, Wi, Wjs, Pore_id, j);
      Return += Mass_density_bulk * Conductivity * (Pi - Pjs[iCounter]);
    }
  }
...
reverse_mode<double> PNMsolver::func_BULK_PHASE_FLOW_kong(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id) {
  ...
  for (int j = Pb[Pore_id].full_accum_ori - Pb[Pore_id].full_coord_ori;
    ...
    if (Tb[j].ID_2 < inlet) // 大孔进口
    {
      if (Pb[Tb[j].ID_1].pressure > Pb[Tb[j].ID_2].pressure) {
        RETURN += conductivity_bulk_kong(Pi, Pjs, Wi, Wjs, Pore_id, j) *
                  (Pi - Pjs[iCounter]);
      } else {
        RETURN += conductivity_bulk_kong(Pi, Pjs, Wi, Wjs, Pore_id, j) *
                  (Pi - Pjs[iCounter]);
    ...
    } else if (Tb[j].ID_2 >= macro_n &&
               Tb[j].ID_2 < macro_n + m_inlet) // 微孔进口边界
    {
      if (Pb[Tb[j].ID_1].pressure > Pb[Tb[j].ID_2].pressure) {
        RETURN += conductivity_bulk_kong(Pi, Pjs, Wi, Wjs, Pore_id, j) *
                  (Pi - Pjs[iCounter]);
...
reverse_mode<double> PNMsolver::conductivity_bulk_kong(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id,
    int throat_id) {
  int i = throat_id;
  ...
  if (Pb[Tb_in[i].ID_1].type == 2 && Pb[Tb_in[i].ID_2].type == 2) {
    ...
    Tb_in[i].Conductivity =
        temp1 * temp2 * temp3 / (temp1 * temp2 + temp2 * temp3 + temp1 * temp3);
    reverse_mode<double> conductivity = Tb_in[i].Conductivity;
    return conductivity;
  } else {
...
reverse_mode<double> PNMsolver::conductivity_co2_DISPERSION_kong(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id,
    int throat_id) {
  ...
  if (Pb[Tb_in[i].ID_1].type == 2 && Pb[Tb_in[i].ID_2].type == 2) {
    temp1 = Apparent_K_ID1 * pi * pow(Pb[Tb_in[i].ID_1].Radiu, 2) /
            (Pb[Tb_in[i].ID_1].Radiu);
    temp2 = kong::D_dispersion_macro * pi * pow(Tb_in[i].Radiu, 2) /
            (Tb_in[i].Length);
    temp3 = Apparent_K_ID2 * pi * pow(Pb[Tb_in[i].ID_2].Radiu, 2) /
    ...
    Tb_in[i].dispersion_coe_co2 =
        ...
        (temp2 * temp3 * temp4 + temp1 * temp3 * temp4 + temp1 * temp2 * temp4 +
         temp1 * temp2 * temp3);
    reverse_mode<double> conductivity = Tb_in[i].dispersion_coe_co2;
    return conductivity;
    /*rong_debug*/
...
reverse_mode<double> PNMsolver::func_TRANSPORT_FLOW_kong(
    reverse_mode<double> &Pi, reverse_mode<double> *Pjs,
    reverse_mode<double> &Wi, reverse_mode<double> *Wjs, int Pore_id) {
  reverse_mode<double> Return{0};
  reverse_mode<double> Conductivity{0};
  ...
  for (int j = Pb[Pore_id].full_accum_ori - Pb[Pore_id].full_coord_ori;
    ...
    if (Pb[Tb_in[j].ID_1].pressure > Pb[Tb_in[j].ID_2].pressure) {
      ...
      Conductivity_dis_co2 =
          conductivity_co2_DISPERSION_kong(Pi, Pjs, Wi, Wjs, Pore_id, j);
      ...
      Return += Wjs[iCounter] * Conductivity *
                (Pi - Pjs[iCounter]); // co2 advection term
      Return += Conductivity_dis_co2 * (Wi - Wjs[iCounter]);
    }
  }
...
#pragma omp parallel for num_threads(int(OMP_PARA))
  ...
  double n_ad2 = n_max_ad * (K_langmuir * (outlet_pre + refer_pressure) /
...
#pragma omp parallel for num_threads(int(OMP_PARA)) reduction(+ : total_macro)
  ...
  for (int i = inlet; i < macro_n - outlet; i++) {
    total_macro +=
        ...
        outlet_pre * Pb[i].volume * 16 / (compre_2 * 8.314 * Temperature);
  }
#ifdef _OPENMP
#pragma omp parallel for num_threads(int(OMP_PARA))                            \
    reduction(+ : total_micro_free, total_micro_ad)
#endif
  for (int i = macro_n + m_inlet; i < pn - m_outlet; i++) {
    total_micro_free +=
        (inlet_pre + refer_pressure) * (porosity - n_ad1 / Rho_ad) *
            Pb[i].volume * 16 / (compre_1 * 8.314 * Temperature) -
        outlet_pre * Pb[i].volume * (porosity - n_ad2 / Rho_ad) * 16 /
  ...
  for (int i = inlet; i < op + inlet; i++) {
    ...
    for (int j = Pb[i].full_accum - Pb[i].full_coord; j < Pb[i].full_accum;
      ...
      if ((inlet <= Tb[j].ID_2) && Tb[j].ID_2 < (op + inlet)) {
        ...
        counter++;
      } else if ((macro_n + m_inlet <= Tb[j].ID_2) &&
                 Tb[j].ID_2 < (macro_n + m_inlet + mp)) {
        coolist[i - inlet] += 1;
        coolist3[i - inlet].push_back(counter);
        counter++;
      } else {
...
#pragma omp parallel for num_threads(int(OMP_PARA))
  ...
  for (int i = inlet; i < op + inlet; i++) {
    ...
    for (int j = Pb[i].full_accum - Pb[i].full_coord; j < Pb[i].full_accum;
         j++) // 找到pjs
    {
      Pjs[j - (Pb[i].full_accum - Pb[i].full_coord)] =
          Pb[Tb[j].ID_2].pressure + refer_pressure;
      Wjs[j - (Pb[i].full_accum - Pb[i].full_coord)] =
          Pb[Tb[j].ID_2].mole_frac_co2;
    }
    ...
    for (int j = Pb[i].full_accum - Pb[i].full_coord; j < Pb[i].full_accum;
      ...
      if ((inlet <= Tb[j].ID_2) && Tb[j].ID_2 < (op + inlet)) // 连接的是大孔
      {
        ...
        COO_A[op + mp + coolist2[i - inlet] + counter1].col =
            Tb[j].ID_2 - inlet;
        ...
        counter1++;
                 ...
                 Tb[j].ID_2 < (pn - m_outlet)) // 连接的是微孔
      {
        COO_A[op + mp + coolist2[i - inlet] + counter1].row = i - inlet;
        COO_A[op + mp + coolist2[i - inlet] + counter1].col =
            Tb[j].ID_2 - para_macro;
        COO_A[op + mp + coolist2[i - inlet] + counter1].val = Pjs[counter].d(0);
...
#pragma omp parallel for num_threads(int(OMP_PARA))
  ...
  for (int i = macro_n + m_inlet; i < pn - m_outlet; i++) {
    ...
    for (int j = Pb[i].full_accum - Pb[i].full_coord; j < Pb[i].full_accum;
      ...
      if ((inlet <= Tb[j].ID_2) && Tb[j].ID_2 < (op + inlet)) // 连接的是大孔
      {
        COO_A[op + mp + coolist2[i - para_macro] + counter1].row =
            i - para_macro;
        COO_A[op + mp + coolist2[i - para_macro] + counter1].col =
            Tb[j].ID_2 - inlet;
        COO_A[op + mp + coolist2[i - para_macro] + counter1].val =
            Pjs[counter].d(0);
...
#pragma omp parallel for num_threads(int(OMP_PARA))
  ...
  for (int i = inlet; i < op + inlet; i++) {
    ...
    for (int j = Pb[i].full_accum - Pb[i].full_coord; j < Pb[i].full_accum;
         j++) {
      if ((inlet <= Tb[j].ID_2) && Tb[j].ID_2 < (op + inlet)) {
        COO_A[op + mp + coolist2[i - inlet] + counter1 + NA].row =
            i - inlet + op + mp;
        COO_A[op + mp + coolist2[i - inlet] + counter1 + NA].col =
            Tb[j].ID_2 - inlet;
        COO_A[op + mp + coolist2[i - inlet] + counter1 + NA].val =
            Pjs[counter].d(0);

        COO_A[op + mp + coolist2[i - inlet] + counter1 + 2 * NA].row =
            i - inlet + op + mp;
        COO_A[op + mp + coolist2[i - inlet] + counter1 + 2 * NA].col =
            Tb[j].ID_2 - inlet + op + mp;
        COO_A[op + mp + coolist2[i - inlet] + counter1 + 2 * NA].val =
            Wjs[counter].d(0);
        counter++;
        counter1++;
      } else if ((macro_n + m_inlet <= Tb[j].ID_2) &&
                 Tb[j].ID_2 < (pn - m_outlet)) {
        COO_A[op + mp + coolist2[i - inlet] + counter1 + NA].row =
            i - inlet + op + mp;
        COO_A[op + mp + coolist2[i - inlet] + counter1 + NA].col =
            Tb[j].ID_2 - para_macro;
...
#pragma omp parallel for num_threads(int(OMP_PARA))
  ...
  for (int i = macro_n + m_inlet; i < pn - m_outlet; i++) {
    ...
    for (int j = Pb[i].full_accum - Pb[i].full_coord; j < Pb[i].full_accum;
         j++) {
      if ((inlet <= Tb[j].ID_2) && Tb[j].ID_2 < (op + inlet)) {
        COO_A[op + mp + coolist2[i - para_macro] + counter1 + 1 * NA].row =
            i - para_macro + op + mp;
        COO_A[op + mp + coolist2[i - para_macro] + counter1 + 1 * NA].col =
            Tb[j].ID_2 - inlet;
        COO_A[op + mp + coolist2[i - para_macro] + counter1 + 1 * NA].val =
            Pjs[counter].d(0);

        COO_A[op + mp + coolist2[i - para_macro] + counter1 + 2 * NA].row =
            i - para_macro + op + mp;
        COO_A[op + mp + coolist2[i - para_macro] + counter1 + 2 * NA].col =
            Tb[j].ID_2 - inlet + op + mp;
        COO_A[op + mp + coolist2[i - para_macro] + counter1 + 2 * NA].val =
            Wjs[counter].d(0);
        counter++;
        counter1++;
      } else if ((macro_n + m_inlet <= Tb[j].ID_2) &&
...
void PNMsolver::AMGX_solver_C_kong_PNM() {
  ...
  outfile << "inner loop = " << inter_n << "\t"
          ...
          << "dimensionless_time = "
          << time_all / (2000 * voxel_size) *
                 ((area_main_Q().second + area_side_Q().second) /
                  pow(1745 * voxel_size, 2) / 0.2)
          << "\t" << "v_main = " << area_main_Q().first << "\t"
          << "v_side = " << area_side_Q().first << "\t" << "dt = " << dt << "\t"
          << "Peclet_MAIN = "
          << area_main_Q().second /
                 (pow(1745 * voxel_size, 2) * 0.2 * 3641 / 4900) /
                 kong::D_dispersion_macro * 10e-6
          << "\t" << "Peclet_side = "
          << area_side_Q().second /
                 (pow(1745 * voxel_size, 2) * 0.2 * 1259 / 4900) /
                 kong::D_dispersion_macro * 10e-6
  ...
  // ************ begin AMGX solver ************
  int nn{1};
  AMGXsolver_subroutine_co2_mehane(A_amgx, b_amgx, solution_amgx, solver,
                                   n_amgx, nnz_amgx);
  do {
    inter_n = 0;
    do {
    ...
    for (int i = 0; i < inlet; i++) {
      bool exists =
          std::binary_search(inlet_boundary.begin(), inlet_boundary.end(), i);
      for (int j = Pb[i].full_accum_ori - Pb[i].full_coord_ori;
           j < Pb[i].full_accum_ori; j++) {
        ...
        if (exists) {
          ...
          Pb[i].pressure =
              Pb[Tb[j].ID_2].pressure + (Aij * vij / con); // 更新孔隙压力
        } else {
    ...
    for (int i = macro_n + m_inlet; i < pn - m_outlet; i++) {
      ...
      double n_ad_old =
          n_max_ad * (K_langmuir * (inlet_pre + refer_pressure) /
                      (1 + K_langmuir * (inlet_pre + refer_pressure)));
      acu_free_micro +=
          (porosity - n_ad_old / Rho_ad) * (inlet_pre + refer_pressure) *
              Pb[i].volume * 16 / (compre_old * 8.314 * Temperature) -
          (porosity - n_ad_new / Rho_ad) * (Pb[i].pressure + refer_pressure) *
              Pb[i].volume * 16 / (Pb[i].compre * 8.314 * Temperature);
    }
    for (int i = macro_n + m_inlet; i < pn - m_outlet; i++) {
      acu_ad_micro +=
  ...
  for (const auto &file : fileList) {
    if (file.find(string("voxels_number")) != string::npos) {
      ...
      while ((idx = sline.find(shead, idx)) != string::npos &&
             (idx1 = sline.find(sshead, idx1)) != string::npos) {
      ...
      idx1 = 0;
      while ((idx = sline.find(shead, idx)) != string::npos &&
             (idx1 = sline.find("\t", idx1)) != string::npos) {
        istringstream ss(sline.substr(idx + 1, idx1 - idx - 1));
        int ii;
        ss >> ii;
        iputings.push_back(ii);
...
void PNMsolver::initial_condition() {
  ...
  for (int i = 0; i < pn; i++) {
    Pb[i].mole_frac_co2 =
        kong::outlet_co2_mole_farc; //- double(double(i) / double(pn) * 100)
    Pb[i].mole_frac_co2_old = Pb[i].mole_frac_co2;
  }

  for (int i = 0; i < inlet; i++) {
    Pb[i].mole_frac_co2 =
        kong::inlet_co2_mole_frac; //- double(double(i) / double(pn) * 100)
    Pb[i].mole_frac_co2_old = Pb[i].mole_frac_co2;
  }
...
#pragma omp parallel for num_threads(int(OMP_PARA))
  ...
  double compre_2 = compre(outlet_pre);
  double n_ad1 =
      n_max_ad * (K_langmuir * inlet_pre / (1 + K_langmuir * inlet_pre));
  double n_ad2 =
      n_max_ad * (K_langmuir * outlet_pre / (1 + K_langmuir * outlet_pre));
#ifdef _OPENMP
#pragma omp parallel for num_threads(int(OMP_PARA)) reduction(+ : total_macro)
#endif
  for (int i = inlet; i < macro_n - outlet; i++) {
    total_macro +=
        inlet_pre * Pb[i].volume * 16 / (compre_1 * 8.314 * Temperature) -
        outlet_pre * Pb[i].volume * 16 / (compre_2 * 8.314 * Temperature);
  }
#ifdef _OPENMP
#pragma omp parallel for num_threads(int(OMP_PARA))                            \
...
#endif
  for (int i = macro_n + m_inlet; i < pn - m_outlet; i++) {
    total_micro_free += inlet_pre * (porosity - n_ad1 / Rho_ad) * Pb[i].volume *
                            16 / (compre_1 * 8.314 * Temperature) -
                        outlet_pre * Pb[i].volume *
...
#pragma omp parallel for num_threads(int(OMP_PARA))                            \
  ...
  double Slip{0};
#ifdef _OPENMP
#pragma omp parallel for num_threads(int(OMP_PARA)) private(                   \
        Knusen_number, Average_pressure, Average_compre, Average_visco, Slip,  \
...
double PNMsolver::macro_outlet_Q() {
  ...
  for (int i = 0; i < inlet; i++) {
    for (int j = Pb[i].full_accum_ori - Pb[i].full_coord_ori;
      ...
      reverse_mode<double> *Wjs;
      Q_outlet +=
          abs((Pb[Tb[j].ID_1].pressure - Pb[Tb[j].ID_2].pressure) *
              conductivity_bulk_kong(Pi, Pjs, Wi, Wjs, i, j).val()); // 体积流量
    }
  }
  return abs(Q_outlet);
}; // 出口大孔流量
  ...
  for (int i = 0; i < inlet; i++) {
    ...
    for (int j = Pb[i].full_accum_ori - Pb[i].full_coord_ori;
      ...
      if (exists) {
        ...
        v_outlet +=
            abs((Pb[Tb[j].ID_1].pressure - Pb[Tb[j].ID_2].pressure) * con) /
            Aij; // 体积流量
        Q_outlet +=
            abs((Pb[Tb[j].ID_1].pressure - Pb[Tb[j].ID_2].pressure) * con);
        icount += 1;
...
double PNMsolver::Peclet_number() {
  ...
  Peclet = Peclet * (2000 * voxel_size) /
           (kong::D_dispersion_macro * pow(1745 * voxel_size, 2) * 0.2);
  return Peclet;
}
...
double PNMsolver::micro_free_mass_loss() {
  ...
  for (int i = macro_n + m_inlet; i < pn - m_outlet; i++) {
    ...
    micro_mass_loss +=
        (porosity - n_ad_old / Rho_ad) * (Pb[i].pressure_old + refer_pressure) *
            Pb[i].volume * 16 / (Pb[i].compre_old * 8.314 * Temperature) -
        (porosity - n_ad_new / Rho_ad) * (Pb[i].pressure + refer_pressure) *
            Pb[i].volume * 16 / (Pb[i].compre * 8.314 * Temperature);
  }
...
void PNMsolver::AMGXsolver_subroutine_co2_mehane(
    AMGX_matrix_handle &A_amgx, AMGX_vector_handle &b_amgx,
    AMGX_vector_handle &solution_amgx, AMGX_solver_handle &solver, int n_amgx,
    int nnz_amgx) {
  ...
  for (size_t i = inlet + op; i < inlet + op + outlet; i++) {
    Pb[i].mole_frac_co2 =
        Pb[Tb[Pb[i].full_accum - Pb[i].full_coord].ID_2].mole_frac_co2;
  }
  for (size_t i = macro_n + m_inlet + mp; i < macro_n + m_inlet + mp + m_outlet;
       i++) {
    Pb[i].mole_frac_co2 =
        Pb[Tb[Pb[i].full_accum - Pb[i].full_coord].ID_2].mole_frac_co2;
  }
...
void PNMsolver::AMGXsolver_subroutine_kong(AMGX_matrix_handle &A_amgx,
                                           AMGX_vector_handle &b_amgx,
                                           AMGX_vector_handle &solution_amgx,
                                           AMGX_solver_handle &solver,
                                           int n_amgx, int nnz_amgx) {}

reverse_mode<double> PNMsolver::func(reverse_mode<double> &Pi,
                                     reverse_mode<double> *&Pjs, int Pore_id) {
  reverse_mode<double> RETURN;
  size_t counter{0};
  for (int j = Pb[Pore_id].full_accum_ori - Pb[Pore_id].full_coord_ori;
       j < Pb[Pore_id].full_accum; j++) {
    if (Tb[j].ID_2 < inlet) // 大孔进口
    {
      if (Pb[Tb[j].ID_1].pressure > Pb[Tb[j].ID_2].pressure) {
    ...
    } else if (Tb[j].ID_2 >= pn - m_outlet) // 微孔出口边界
    {
      ...
      RETURN += Tb[j].Surface_diff_conduc *
                (K_langmuir * Pi / (1 + K_langmuir * Pi) -
                 K_langmuir * Pjs[counter] / (1 + K_langmuir * Pjs[counter]));
      counter++;
    }
  }
  return RETURN;
