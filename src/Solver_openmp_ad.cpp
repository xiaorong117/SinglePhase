 ...
 */
  ...
  B[op + mp] = 0.01 * 0.01 * 0.01 * 0.01 / 60;
  B[op + mp + 1] = 0.001 * 0.01 * 0.01 * 0.01 / 60;
...
void PNMsolver::EIGEN_GPU_velocity_boundary_incompressible_per() {
  Flag_eigen = false;
  Flag_Hybrid = false;
...
void PNMsolver::AMGX_velocity_boundary_incompressible_per() {
  Flag_eigen = false;
  Flag_Hybrid = false;
  auto start1 = high_resolution_clock::now();
  double acu_flow_macro{0}, acu_free_micro{0}, acu_ad_micro{0};
